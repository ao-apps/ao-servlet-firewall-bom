...
def upstreamProjects = [
  ...
  'filter', // <groupId>com.aoapps</groupId><artifactId>ao-servlet-firewall-filter</artifactId>
  ...
  'virtual-hosts', // <groupId>com.aoapps</groupId><artifactId>ao-servlet-firewall-virtual-hosts</artifactId>
  'virtual-hosts-path-space', // <groupId>com.aoapps</groupId><artifactId>ao-servlet-firewall-virtual-hosts-path-space</artifactId>
  'webjars', // <groupId>com.aoapps</groupId><artifactId>ao-servlet-firewall-webjars</artifactId>
]
